...
public class Interpreter {
    ...
    public int getValue(String param1) {
        switch (param1) {
            case "A":
    ...
    public void doCommand(String rozkaz, String param1, String param2, boolean argDrugiJestRejestrem,
        ...
        switch (rozkaz) {
            ...
            case "HT": // Koniec programu
                ...
                if (PCBbox.getproces(id).children.isEmpty()) {
                    PCBbox.kill(id);
                } else {
    ...
    public void work(String program, HashMap<String, Integer> labels) {
        ...
        for (Character c : program.toCharArray()) {
            if (c == '\n') {
                ...
                if (program.contains(" :")) {
//for(int i=0; i<program.length()-2;i++) {s_etykieta+=program[i];}
//s_etykieta+=":";
                ...
                if (rozkazToEtykieta) {
                    String temp = "";
                    for (Character z : (s_etykieta.toString()).toCharArray()) {
                        if (z != ':') {
                            temp += z;
                        } else {
